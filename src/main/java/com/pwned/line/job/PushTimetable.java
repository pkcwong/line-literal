...
public class PushTimetable extends DefaultJob {
	...
	public static int convertDay(String day) {
		...
		switch (day) {
			case "Mo":
				convertedDay = Calendar.MONDAY;
				break;
			case "Tu":
				convertedDay = Calendar.TUESDAY;
				break;
			case "We":
				convertedDay = Calendar.WEDNESDAY;
				break;
			case "Th":
				convertedDay = Calendar.THURSDAY;
				break;
			case "Fr":
				convertedDay = Calendar.FRIDAY;
				break;
			case "Sa":
				convertedDay = Calendar.SATURDAY;
				break;
			case "Su":
				convertedDay = Calendar.SUNDAY;
				break;
		}
		return convertedDay;
	}
